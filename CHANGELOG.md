...
- fix: XLSX generation fails with IllegalArgumentException when schema names exceed 31 characters and share a common prefix <https://github.com/fugerit-org/openapi-doc-tool/issues/2>
